...
public class DuplicateLead extends CreateLead {
	/*
	 * WebDriver driver;
	 * 
	 * public DuplicateLead(WebDriver driver) { this.driver = driver;
	 * 
	 * }
	 */
/*
	...
	public void duplicateLead() throws InterruptedException {
		...
		WebElement DUPLICATE_LEAD_BUTTON = driver.findElement(By.linkText("Duplicate Lead"));
		Thread.sleep(6000);
		DUPLICATE_LEAD_BUTTON.click();
		WebElement DUPLICATE_NAME = driver.findElement(By.xpath("//input[@id='createLeadForm_companyName']"));
		DUPLICATE_NAME.sendKeys("B");
		
	//	ProjectSpecificWrapper projectSpecificWrapper = new ProjectSpecificWrapper();
